...
//        View view = inflater.inflate(R.layout.activity_edit_profile, container, true);
//
//        findAllViews(view);
//        setTitleBar();
//        setIconKey();//设置字段
...
//                Toast.makeText(getActivity(), "获取用户字段信息失败！错误码：" + s, Toast.LENGTH_SHORT).show();
//            }
//
//            @Override
...
//                    @Override
//                    public void onError(int i, String s) {
//                        Toast.makeText(getActivity(), "更新签名失败！错误码：" + i, Toast.LENGTH_SHORT).show();
//                    }
//
//                    @Override
//                    public void onSuccess() { //更新信息成功
